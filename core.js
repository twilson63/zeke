...
skeleton = function(data) {
  var coffeescript, comment, doctype, h, ie, inline, tag, text, __cc, _ref, _ref1;
  if (data == null) {
    data = {};
  }
...
zeke.compile = function(template, options) {
  var code, hardcoded_locals, hc, t, tag_functions, tags_used, _i, _j, _len, _len1, _ref;
  if (options == null) {
    options = {};
  }
  ...
  if (zeke.helpers != null) {
    hc(zeke.helpers);
  }
  if (options.hardcode != null) {
    hc(options.hardcode);
  }
  tag_functions = '';
  tags_used = [];
